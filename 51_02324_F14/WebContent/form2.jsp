...
<body id="main-body">
  ...
  <tr>
    <td><li id="li_3" name="li_3"><label class="description" for="element_3"><% if (request.getParameter("fail") != null) out.print("Batch navn ikke genkendt! -"); %>Indtast
							Batch navn </label>
						<div>
